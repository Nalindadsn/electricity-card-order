...
<?php if (pr($prArray[11])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="street.php">
                                <i class="fas fa-dot-circle text-primary"></i>  මාර්ග </a>
                            </a>
                        </li>
<?php } ?>
                    </ul>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.php">Street</a>
        <!-- Form -->
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Post Office</a></li>
...
?>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      ...
      <label class="form-label" >තැපැල් කාර්යාලය</label>
      <select id="t_change" class="form-control form-select-lg mb-3" aria-label=".form-select-lg example">
      ...
      <label class="form-label" >ප්‍රදේශය </label>
      <select id="ttwo_change" class="form-control form-select-lg mb-3" aria-label=".form-select-lg example">
        <option>-- division --</option>
      </select>
  
      <label class="form-label" >ගම</label>
      <select id="tthree_result" name="tthree_result" class="form-control form-select-lg mb-3" aria-label=".form-select-lg example">
...
"lengthMenu":[[10,25,50,-1],[10,25,50,"All"]],
  ...
  $(document).on('submit', '#user_form', function(event){
    ...
    var tthree_result = $('#tthree_result').val();
 
    if(tthree_result != '')
    {
      $.ajax({
        url:"admin/insert22.php",
        method:'POST',
...
// country dependent ajax
 $(document).on("change","#t_change", function(e){
  e.preventDefault();
  ...
  $("#ttwo_change").val('')
      ...
      var tthreeBody3 = "";
      tthreeBody3 = "<option value=''>-- Select Division --</option>"
      $("#tthree_result").html(tthreeBody3);


  var country = $("#t_change").val(); 
  ...
  $.ajax({
    ...
    dataType: "json",
      ...
      if (response) {
      ttwoBody = "<option value=''>-- Select Division --</option>"
 ...
 $(document).on("change","#ttwo_change", function(e){
  ...
  $.ajax({
    ...
    dataType: "json",
      ...
      var tthreeBody = "";
      tthreeBody = "<option value=''>-- Select Village --</option>"
