...
Class Dropdown1
{
	...
	public function fetchTwo($tone_id)
	{
		...
		$query = "SELECT * FROM ttwo1 WHERE tone_id='".$tone_id."' ";
	...
	public function fetchThree($ttwo_id)
	{
		...
		$query = "SELECT * FROM tthree1 WHERE ttwo_id='".$ttwo_id."' ";
	...
	public function fetchFour($tthree_id)
	{
		...
		$query = "SELECT * FROM tfour1 WHERE tthree_id='".$tthree_id."' ";
