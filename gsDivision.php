...
<?php if (pr($prArray[15])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link " href="gsDivision.php">
                                <i class="fas fa-dot-circle text-primary"></i> ග්‍රාම නිලධාරි වසම් </a>
                            </a>
                        </li>
<?php } ?>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.php">GS DIVISION</a>
        <!-- Form -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">ග්‍රාම සේවක වසම්</h3>
            </div>
...
?>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="">
        ...
        <select name="i_idv" id="i_idv" class="form-control" >
