...
<?php if (pr($prArray[33])==1) { ?>
          ...
          <li class="nav-item  active shadow">
              ...
              <a class="nav-link active" href="#binSub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <ul class="collapse show list-unstyled mx-3" id="binSub" >
...
<?php if (pr($prArray[39])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="expensesCatBin.php">
                                <i class="fas fa-dot-circle text-primary"></i> expenses categories </a>
                            </a>
                        </li>
<?php } ?>
                    </ul>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Expenses Categories</a>
        <!-- Form -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">expenses categories</h3>
            </div>
...
$(document).ready(function(){
  ...
  var dataTable = $('#user_data').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin/fetch_expensesCatBin.php",
      type:"POST"
    },
      dom: 'Bfrtip',
...
$(document).on('click', '.update', function(){
  ...
  $(document).on('click', '.delete', function(){
    ...
    {
      $.ajax({
        url:"admin/active_expenses_cat.php",
        method:"POST",
        data:{i_id:i_id},
        success:function(data)
        {
