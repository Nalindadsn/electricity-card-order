...
<?php if (pr($prArray[10])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="villages.php">
                                <i class="fas fa-dot-circle  text-primary"></i>  ගම් </a>
                            </a>
                        </li>
<?php } ?>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.php">Village</a>
        <!-- Form -->
...
?>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      ...
      <select id="ttwo_change" name="ttwo_change" class="form-control form-select-lg mb-3" aria-label=".form-select-lg example">
...
"lengthMenu":[[10,25,50,-1],[10,25,50,"All"]],
  ...
  $(document).on('submit', '#user_form', function(event){
    ...
    var ttwo_change = $('#ttwo_change').val();

    if(i_name != '')
    {
      $.ajax({
        url:"admin/insert21.php",
        method:'POST',
