...
<?php if (pr($prArray[8])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="postOffice.php">
                                <i class="fas fa-dot-circle  text-primary"></i>  තැපැල් කාර්යාල </a>
                            </a>
                        </li>
<?php } ?>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">තැපැල් කාර්යාල</h3>
            </div>
...
$(document).ready(function(){
  ...
  var dataTable = $('#user_data').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin/fetch_postOffice.php",
      type:"POST"
    },
      dom: 'Bfrtip',
