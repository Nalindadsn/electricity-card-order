              ...
              <form role="form"   action="authenticate.php" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    if (isset($_GET['id'])) {
                    ?>
                              <input  type="text" name="idno" placeholder="idno" id="idno" required class="form-control" value="<?php echo $_GET['id'] ?>">
                    <?php
                    }else{
                      ?>
                              <input  type="text" name="idno" placeholder="idno" id="idno" required class="form-control">
                      <?php
                    }
                     ?>
                  </div>
