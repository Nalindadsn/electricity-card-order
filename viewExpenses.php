...
$stmtcat = $pdo->prepare("SELECT * FROM excategory WHERE id='".$_GET['id']."'");
$stmtcat->execute();
...
<!--                         <li class="nav-item">
          ...
          <li class="nav-item  active ">
              ...
              <a class="nav-link active" href="#expSub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <i class="ni ni-align-left-2 text-blue"></i> Expenses </a>
                    <ul class="collapse list-unstyled mx-3 show" id="expSub" >
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="expenses.php">
                                <i class="fas fa-dot-circle text-primary"></i>  expenses </a>
                            </a>
                        </li>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Expenses</a>
        <!-- Form -->
...
<?php echo $accounts['username']; ?>
    ...
    <!-- Sidebar -->
    <div id="sidebar-wrapper m-0">
      <ul class="sidebar-nav">
        <?php 

foreach (excat() as $keyV) {
  if ($keyV['id']==$_GET['id']) {
   ?>
        <li class="sidebar-brand bg-primary p-1 my-1">
          <a href="viewexpenses.php?id=<?php echo $keyV['id']; ?>" class="m-3 text-white">
              <?php echo $keyV['name']; ?>
          </a>
        </li>
   <?php
   ...
   ?>
        <li class="sidebar-brand bg-secondary py-1 my-1">
          <a href="viewexpenses.php?id=<?php echo $keyV['id']; ?>" class="m-3">
              <?php echo $keyV['name']; ?>
          </a>
        </li>
   <?php
...
$(document).ready(function(){
  ...
  var dataTable = $('#user_data').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin/fetch_expenses_cat.php",
      type:"POST",
        'data': {
           formName: 'default',
