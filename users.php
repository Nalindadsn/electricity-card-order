    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="password" id="password" class="form-control" value="123456" />
          <br />
          <!-- <label>Confirm Password</label> -->
          <input type="hidden" name="confirm_password" id="confirm_password" class="form-control" value="123456" />
          <br />
