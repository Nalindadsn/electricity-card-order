...
<?php if (pr($prArray[16])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="billingDivision.php">
                                <i class="fas fa-dot-circle text-primary"></i> බිල් කලාපය </a>
                            </a>
                        </li>
<?php } ?>
                    </ul>
...
?>
    <form method="post" id="user_form" enctype="multipart/form-data">
      ...
      <label class="form-label" >කරාමය</label>
      ...
      <label class="form-label" >ග්‍රාම නිලධාරි කොට්ඨාසය </label>
