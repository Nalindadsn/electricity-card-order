                    ...
                    <ul class="collapse list-unstyled mx-3 show" id="binSub" >
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="usersBin.php">
                                <i class="fas fa-dot-circle text-primary"></i> Customers </a>
                            </a>
                        </li>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="users.php">Customers</a>
        <!-- Form -->
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="users.php">Bin</a></li>
                  <li class="breadcrumb-item"><a href="users.php">Customers</a></li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <!-- <a href="#" class="btn btn-sm btn-neutral">Add New Customer</a> -->
            </div>
          </div>
        </div>
      </div>
