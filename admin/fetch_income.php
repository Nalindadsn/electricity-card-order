...
$query = '';
$output = array();
$query .= 'SELECT income.*,accounts.idno AS idno,acc_cat.name AS acc_type,account_con.status AS ac_status, account_con.measurement_no AS measurement_no,accounts.username AS username FROM income 
