...
{
	include('db.php');
	$statement = $pdo->prepare("SELECT * FROM accounts WHERE role='Admin' AND  activation_code != 'activated'");
	$statement->execute();
...
$query = '';
$output = array();
$query .= 'SELECT * FROM accounts WHERE (role="Admin" AND activation_code != "activated") ';
