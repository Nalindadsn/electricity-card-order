...
$sub_array[] ="USER TYPE : ".$row['role']."<br><span class='badge badge-pill badge-primary'>".$row['email']."</span><br>NIC : ".$row['idno']."<br>No of Accounts : ".countCon($row['id'])."<hr class='m-1'>".'<a href="userProfile.php?id='.$row['id'].'">view profile</a>';
...
// }
	...
	if ($row['activation_code']=="activated") {
		# code...
		$sub_array[] = '<span class="badge badge-pill badge-success">Activated</span>'.'<br><br>

		<a href="findAccounts.php?id='.$row['idno'].'">view Accounts</a>';
	}
	else {
		# code...
