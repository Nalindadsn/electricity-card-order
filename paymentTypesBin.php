...
<?php if (pr($prArray[30])==1) { ?>
          ...
          <li class="nav-item  active shadow">
              ...
              <a class="nav-link active" href="#paySub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <ul class="collapse show list-unstyled mx-3" id="paySub" >
...
<?php if (pr($prArray[32])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="paymentTypes.php">
                                <i class="fas fa-dot-circle text-primary"></i> ගෙවීම් categories  </a>
                            </a>
                        </li>
<?php } ?>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Post Office</a>
        <!-- Form -->
