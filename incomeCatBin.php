...
<?php if (pr($prArray[38])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="incomeCatBin.php">
                                <i class="fas fa-dot-circle text-primary"></i> ආදායම් categories </a>
                            </a>
                        </li>
<?php } ?>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Income Categories</a>
        <!-- Form -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">ආදායම් categories</h3>
            </div>
...
$(document).ready(function(){
  ...
  var dataTable = $('#user_data').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin/fetch_incomeCatBin.php",
      type:"POST"
    },
      dom: 'Bfrtip',
...
$(document).on('click', '.update', function(){
  ...
  $(document).on('click', '.delete', function(){
    ...
    {
      $.ajax({
        url:"admin/active_income_cat.php",
        method:"POST",
        data:{i_id:i_id},
        success:function(data)
        {
