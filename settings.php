...
<!--                         <li class="nav-item">
          ...
          <li class="nav-item  active ">
              ...
              <a class="nav-link active" href="#settingsSub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <ul class="collapse list-unstyled mx-3 show" id="settingsSub" >


                        <li class="nav-item">
                            <a  class="nav-link" href="settings.php">
                                <i class="fas fa-dot-circle  text-primary"></i> Other </a>
                            </a>
                        </li>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Settings</a>
        <!-- Form -->
...
<form method="POST" id="myForm">
    <input type="text" name="fontSize" id="fontSize" class="form-control" max="25">
    <br>
    <input type="submit" name="submit" class="btn btn-primary" id="submit" value="Change Font Size">
...
<div id="fontSizeTxt"></div>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="">
        ...
        <div class="">
          <label>Name <span id="sp" class="btn btn-sm btn-primary">name</span></label>
...
event.preventDefault();
    ...
    if (myObj_deserialized.fontSizeV) {
        ...
        $('#fontSizeTxt').html("<span >font-size :"+myObj_deserialized.fontSizeV+"px</span><hr>")
        ...
        $("<style>body > div > div.container-fluid.mt--7 *{font-size:15px;}</style>").appendTo("head")
    } 
