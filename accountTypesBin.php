...
<!--                         <li class="nav-item">
          ...
          <li class="nav-item  active ">
              ...
              <a class="nav-link active" href="#binSub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <i class="fa fa-trash text-red"></i> Bin </a>
                    <ul class="collapse list-unstyled mx-3 show" id="binSub" >
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="accountTypesBin.php">
                                <i class="fas fa-dot-circle  text-primary"></i> Account Types </a>
                            </a>
                        </li>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Account Categories</a>
        <!-- Form -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Bin</a></li>
            ...
            <div class="col-lg-6 col-5 text-right">
             <!--  <a id="add_button" class="btn btn-sm btn-neutral">Add Category</a> -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Account Types</h3>
            </div>
        ...
        $.ajax({
            ...
            success: function(data) {
              // console.log(data)
                if(data.count > 0) {
                  if (data.bal>=0) {
                    $("#msg").html(''+' <span>Full Name : '+data.un+'</span> <br> <span>Username : '+data.usn+'</span><span  class="badge badge-primary">Accounts :'+data.noAcc+' </span>&nbsp;&nbsp;Meter Board : '+data.meter+'<br>'+'<span  class="badge badge-success float-right"> Account Balance : '+data.bal+'</span>');
                  }else{

                    $("#msg").html(''+' <span">Full Name : '+data.un+'</span><br>  <span>Username : '+data.usn+'</span> <span  class="badge badge-primary">Accounts :'+data.noAcc+' </span>&nbsp;&nbsp;Meter Board : '+data.meter+'<br>'+'<span   class="badge badge-danger float-right">Account Balance : LKR '+data.bal+'</span>');
                  }
...
$(document).ready(function(){
  ...
  var dataTable = $('#user_data').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin/fetch_accountTypesBin.php",
      type:"POST"
    },
      dom: 'Bfrtip',
