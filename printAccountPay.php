    ...
    <div class="container d-flex justify-content-center mt-50 mb-50">
        <div class="row">
            <div class="col-md-12 text-right mb-3">
                ...
                <button class="btn btn-primary" value="print" onclick="PrintDiv();"><i class="fa fa-print"></i>Print   </button>   
            </div>
            <div class="col-md-12">
                <div class="card" id="invoice">
                    <div class="card-header bg-transparent header-elements-inline">
                        <h6 class="card-title text-primary"> INCOME</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4 ">
                                    <div class="text-sm-right">
                                        <h4 class="invoice-color mb-2 mt-md-2">Transaction ID #PY00<?php echo $_GET['id']; ?></h4>
...
<br><br>
    ...
    function PrintDiv() {    
       ...
       popupWin.document.write('<html><head><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" crossorigin="anonymous"></head><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
