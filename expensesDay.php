...
<?php if (pr($prArray[22])==1) { ?>
                        ...
                        <li class="nav-item">
                            <a  class="nav-link" href="expensesReport.php">
                                <i class="fas fa-dot-circle text-primary"></i> expenses වාර්තා </a>
                            </a>
                        </li>
<?php } ?>
...
<!-- sidenav end -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.php">Expenses Report <?php echo $_GET['year']."-".$_GET['day'] ?></a>
        <!-- Form -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Income <span class="text-primary"> <?php echo $_GET['year']."-".$_GET['day'] ?></span> </h3>
            </div>
...
if (date('Y')==$v['year']) {
    ?>
        ...
        <li class="nav-item  ">
          <a class="nav-link active" href="expensesReport.php?year=<?php 
           echo $v['year']; ?>"><?php 
           echo $v['year']; ?></a>
        </li>
    <?php
...
?>
        <li class="nav-item">
          <a class="nav-link" href="expensesReport.php?year=<?php 
           echo $v['year']; ?>"><?php 
           echo $v['year']; ?></a>
        </li>
<?php
...
<?php 
  if (!isset($_GET['year'])) {
    foreach (expenses(date('Y')) as $v) {
    ?>
        <li class="nav-item  ">
          <a class="nav-link active" href="expensesDay.php?year=<?php 
...
foreach (expenses($_GET['year']) as $v) {
    ?>
        <li class="nav-item  ">
          <a class="nav-link active" href="expensesDay.php?year=<?php 
           echo $v['MonthY']; ?>&day=<?php 
      ...
      <div class="table-responsive">
        ...
        <table id="user_data" class="table align-items-center table-dark table-flush">
          <thead>
            <tr>
              <th width="10%">Name</th>
              <th width="10%" align="center"><span class="float-right">මුදල</span></th>
            </tr>
          </thead>
          <tbody>
...
//print_r(expensesM(date('Y'),date('m'))) ;
  ...
  if (!isset($_GET['year'])) {
    foreach (expensesM(date('Y'),date('m')) as $v) {
    ?>
...
foreach (expensesM($_GET['year'],$_GET['day']) as $v) {
    ?>
