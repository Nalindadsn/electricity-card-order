...
<?php if ( pr($prArray[50])==1) { ?>
              ...
              <a href="#" class="btn btn-sm btn-neutral" id="modal_button" >තැපැල් කාර්යාලය ඇතුල් කරන්න</a>
<?php } ?>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="m_id"></div>
          <br />
          <label id=poLbl>තැපැල් කාර්යාලය</label>
